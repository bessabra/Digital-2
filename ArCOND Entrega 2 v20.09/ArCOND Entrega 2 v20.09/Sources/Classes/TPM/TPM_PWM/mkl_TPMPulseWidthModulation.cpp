...
mkl_TPMPulseWidthModulation::mkl_TPMPulseWidthModulation(tpm_Pin pin) {
  ...
  setTPMParameters(pin, pinNumber, GPIONumber, chnNumber,TPMNumber, muxAltMask);
 ...
 */
void mkl_TPMPulseWidthModulation::setFrequency(tpm_Div divBase, uint16_t MODRegister) {
  /*!
